...
export class CancelOrderUseCase {
  ...
  async execute(orderId: string, userRole: string, reason?: string, userId?: string): Promise<boolean> {
    ...
    // Validar permisos: ADMIN/VENDOR pueden cancelar cualquier orden, USER solo sus propias órdenes
    const isAdmin = ['ADMIN', 'VENDOR'].includes(userRole);
